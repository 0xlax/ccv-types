...
func (m *ValidatorPacket) Reset()         { *m = ValidatorPacket{} }
func (m *ValidatorPacket) String() string { return proto.CompactTextString(m) }
func (*ValidatorPacket) ProtoMessage()    {}
func (*ValidatorPacket) Descriptor() ([]byte, []int) {
	return fileDescriptor_68bd5f3242e6f29c, []int{0}
}
func (m *ValidatorPacket) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ValidatorPacket) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ValidatorPacket.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *ValidatorPacket) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ValidatorPacket.Merge(m, src)
}
func (m *ValidatorPacket) XXX_Size() int {
	return m.Size()
}
func (m *ValidatorPacket) XXX_DiscardUnknown() {
	xxx_messageInfo_ValidatorPacket.DiscardUnknown(m)
}

var xxx_messageInfo_ValidatorPacket proto.InternalMessageInfo

func (m *ValidatorPacket) GetValidatorUpdates() []types.ValidatorUpdate {
	if m != nil {
...
func (m *ValidatorPacket) GetValsetUpdateId() uint64 {
	if m != nil {
...
func (m *ValidatorPacket) GetSlashAcks() []string {
	if m != nil {
		return m.SlashAcks
	}
	return nil
...
func init() {
	proto.RegisterType((*ValidatorPacket)(nil), "interchain_security.ccv.v1.ValidatorPacket")
...
func (m *ValidatorPacket) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *ValidatorPacket) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ValidatorPacket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ValidatorPacket) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ValidatorPacket) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: ValidatorPacket: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValidatorPacket: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
